...
from utils import   graficar_combinaciones, buscar_ciudad, obtener_top_5_ciudades,\
                    connect_to_db,fetch_all_from_table, prompt_basico, prueba, modify_table_records, \
                    check_admin_details
